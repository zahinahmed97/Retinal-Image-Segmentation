# -*- coding: utf-8 -*-
"""
Created on Tue M  13 00:53:25 2020
...
model = model_from_json(open('model_architecture_trial4.json').read())
model.load_weights('Model_best_weights_trial4.h5')
...
visualize(group_images(orig_imgs,N_visual),"all_originals_trial4")#.show()
visualize(group_images(pred_imgs,N_visual),"all_predictions_trial4")#.show()
visualize(group_images(gtruth_masks,N_visual),"all_groundTruths_trial4")#.show()
...
for i in range(int(N_predicted/group)):
    ...
    visualize(total_img,"_Original_GroundTruth_Prediction_trial4"+str(i))#.show()
...
plt.legend(loc="lower right")
plt.savefig("Precision_recall_trial4.png")
...
#Save the results
file_perf = open('performances_trial4.txt', 'w')
